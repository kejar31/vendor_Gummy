...
ALARM_PATH := vendor/Gummy/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/Gummy/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/Gummy/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/Gummy/prebuilt/common/media/audio/ui
